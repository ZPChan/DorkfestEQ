...
; *** SetupLdr messages
SetupLdrStartupMessage=This will apply patch 1 %1. Do you wish to continue?
...
WelcomeLabel2=This will patch [name/ver] on your computer.%n%nIt is recommended that you close all other applications before continuing.
...
SelectDirLabel3=Setup will patch [name] in the following folder.
...
WizardReady=Ready to Patch
ReadyLabel1=Setup is now ready to begin patching [name] on your computer.
ReadyLabel2a=Click Patch to continue with the installation, or click Back if you want to review or change any settings.
ReadyLabel2b=Click Patch to continue with the installation.
...
WizardPreparing=Preparing to Patch
PreparingDesc=Setup is preparing to patch [name] on your computer.
